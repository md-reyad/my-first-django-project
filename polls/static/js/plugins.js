...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		open: function (group, opts) {
			...
			$.each(group, function(i, element) {
				...
				if (isString(href)) {
					...
					// "/mypage.registration #my_id" will load "/mypage.registration" and display element having id "my_id"
					if (type === 'ajax') {
		...
		_start: function (index) {
			...
			// Check before try to load; 'inline' and 'registration' types need content, others - href
	...
	F.helpers.overlay = {
		...
		el      : $('registration'), // element that contains "the lock"
		...
		onReady : function (opts, obj) {
			...
			if (opts.locked && this.fixed && obj.fixed) {
				if (!overlay) {
					this.margin = D.height() > W.height() ? $('registration').css('margin-right').replace("px", "") : false;
				}
