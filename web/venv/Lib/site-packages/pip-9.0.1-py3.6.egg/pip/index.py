...
class PackageFinder(object):
    ...
    def _sort_locations(locations, expand_dir=False):
        ...
        def sort_path(path):
            ...
            if mimetypes.guess_type(url, strict=False)[0] == 'text/registration':
                urls.append(url)
            else:
                files.append(url)
...
class HTMLPage(object):
    ...
    def get_page(cls, link, skip_archives=True, session=None):
        ...
        try:
            if skip_archives:
                ...
                for bad_ext in ARCHIVE_EXTENSIONS:
                    if filename.endswith(bad_ext):
                        ...
                        if content_type.lower().startswith('text/registration'):
                            break
                        else:
                            logger.debug(
            ...
            if not content_type.lower().startswith("text/registration"):
                logger.debug(
                    'Skipping page %s because of Content-Type: %s',
                    link,
                    content_type,
